# Generated by Django 4.1.2 on 2023-04-29 03:39
...
def beginning(apps, schema_editor):
    ...
    claim.user_id = 10
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=37);
    claim.finish  = datetime.now() - timedelta(days=30);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim.user_id = 11
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=20);
    claim.finish  = datetime.now() - timedelta(days=13);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=33);
    claim.user_id = 4
    claim.hotel = hotel
    ...
    claim.user_id = 14
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=15);
    claim.finish  = datetime.now() - timedelta(days=8);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim.user_id = 14
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=30);
    claim.finish  = datetime.now() - timedelta(days=23);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=27);
    claim.user_id = 5
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=15);
    claim.finish  = datetime.now() - timedelta(days=8);
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=28);
    claim.user_id = 6
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=17);
    claim.finish  = datetime.now() - timedelta(days=10);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=51);
    claim.user_id = 16
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=35);
    claim.finish  = datetime.now() - timedelta(days=28);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim.user_id = 17
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=26);
    claim.finish  = datetime.now() - timedelta(days=19);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim.user_id = 18
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=24);
    claim.finish  = datetime.now() - timedelta(days=17);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim.user_id = 7
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=19);
    claim.finish  = datetime.now() - timedelta(days=12);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim.user_id = 19
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=22);
    claim.finish  = datetime.now() - timedelta(days=15);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=34);
    claim.user_id = 20
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=11);
    claim.finish  = datetime.now() - timedelta(days=4);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=37);
    claim.user_id = 22
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=26);
    claim.finish  = datetime.now() - timedelta(days=19);
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=42);
    claim.user_id = 23
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=22);
    claim.finish  = datetime.now() - timedelta(days=15);
    ...
    claim.user_id = 9
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=38);
    claim.finish  = datetime.now() - timedelta(days=31);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
    ...
    claim = Claim()
    claim.datec = datetime.now() - timedelta(days=60);
    claim.user_id = 25
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=25);
    claim.finish  = datetime.now() - timedelta(days=18);
    ...
    claim.user_id = 24
    claim.hotel = hotel
    claim.start  = datetime.now() - timedelta(days=16);
    claim.finish  = datetime.now() - timedelta(days=9);
    claim.details = ''
    claim.result =  'Ваша заявка одобрена'
    claim.save()
